            ...
            <>
                ...
                <Container>
                    ...
                    >
                        <InfoHeader>
                            <InfoBtn
                                onPress={() => this.handleCall(data.telefone)}
                            >
                        ...
                        <Description
                            onPress={() =>
                                Alert.alert('Continuação', data.texto)
                            }
                        >
                            {data.texto}
                        </Description>
                        ...
                        <CommentList>
                            {comments.map(item => (
                                <Comments key={String(item.titulo)}>
                                    <CommentAvatar
